import { Component, OnInit, Input, forwardRef, ElementRef, ViewChild, AfterViewInit, ViewEncapsulation } from '@angular/core';
import { ComboEntry } from 'src/app/core/services/enum-util.service';
import { NG_VALUE_ACCESSOR, FormControl } from '@angular/forms';
import { trigger, state, style, transition, animate } from '@angular/animations';
import { MatFormFieldControl } from '@angular/material';

// @See https://stackoverflow.com/questions/39661430/angular-2-formcontrolname-inside-component
// Non usato, non usare, va correttamente integrato.

export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SimpleComboComponent),
    multi: true
};
@Component({
...
export class SimpleComboComponent implements OnInit, AfterViewInit {

	@Input() elements: ComboEntry [] = [];
...
//		this.inputRef.nativeElement.value = this.innerValue; 
   ...
   //The internal data model for form control value access
	...
	public compareValues(v1: any, v2: any): boolean {
		console.log('compareValues: [v1][' + JSON.stringify(v1) + '] - [v2][' + JSON.stringify(v2) + ']' + this.innerValue);
		return v1 && v2 && (v1 === v2);
	}
}
